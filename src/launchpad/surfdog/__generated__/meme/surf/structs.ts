...
export type SURFReified = Reified<
    SURF,
    SURFFields
>;
...
export class SURF implements StructClass {
    ...
    static reified(): SURFReified {
        return {
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                SURF.fromSuiParsedData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => SURF.fetch(
                client,
                id,
            ),
            new: (
    ...
    static fromSuiParsedData(
        ...
        return SURF.fromFieldsWithTypes(
            content
        );
    }

...
export type MemCoinOwnerCapReified = Reified<
    MemCoinOwnerCap,
    MemCoinOwnerCapFields
>;

export class MemCoinOwnerCap implements StructClass {
    static readonly $typeName = "0xd06278ad71b5a4d622f179bd21d163d2efc8aaf14e1750884026f63e3d07ca3a::meme::MemCoinOwnerCap";
    ...
    static reified(): MemCoinOwnerCapReified {
        return {
            ...
            fromFields: (fields: Record<string, any>) =>
                MemCoinOwnerCap.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                MemCoinOwnerCap.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                MemCoinOwnerCap.fromBcs(
                    data,
                ),
            bcs: MemCoinOwnerCap.bcs,
            fromJSONField: (field: any) =>
                MemCoinOwnerCap.fromJSONField(
                    field,
                ),
            fromJSON: (json: Record<string, any>) =>
                MemCoinOwnerCap.fromJSON(
                    json,
                ),
            fromSuiParsedData: (content: SuiParsedData) =>
                MemCoinOwnerCap.fromSuiParsedData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => MemCoinOwnerCap.fetch(
                client,
                id,
            ),
            new: (
                fields: MemCoinOwnerCapFields,
            ) => {
                return new MemCoinOwnerCap(
                    [],
                    fields
                )
            },
    ...
    static fromFields(
        ...
        return MemCoinOwnerCap.reified().new(
    ...
    static fromBcs(
        ...
        return MemCoinOwnerCap.fromFields(
            MemCoinOwnerCap.bcs.parse(data)
        )
    }
    ...
    static fromJSON(
        ...
        return MemCoinOwnerCap.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return MemCoinOwnerCap.fromFieldsWithTypes(
            content
        );
    }
    ...
    static async fetch(
        ...
        return MemCoinOwnerCap.fromBcs(
...
export interface StateFields<T extends PhantomTypeArgument> {
    id: ToField<UID>; start: ToField<"u64">; end: ToField<"u64">; nextTick: ToField<"u64">; allTickets: ToField<"u64">; wonTickets: ToField<"u64">; ticketPrice: ToField<"u64">; tokensPerTicket: ToField<"u64">; balance: ToField<Balance<T>>
}

export type StateReified<T extends PhantomTypeArgument> = Reified<
    State<T>,
    StateFields<T>
>;
...
export class State<T extends PhantomTypeArgument> implements StructClass {
    ...
    ; readonly wonTickets:
        ToField<"u64">
    ; readonly ticketPrice:
        ToField<"u64">
    ; readonly tokensPerTicket:
        ToField<"u64">
    ; readonly balance:
        ToField<Balance<T>>
    ...
    private constructor(typeArgs: [PhantomToTypeStr<T>], fields: StateFields<T>,
        ...
        this.id = fields.id;; this.start = fields.start;; this.end = fields.end;; this.nextTick = fields.nextTick;; this.allTickets = fields.allTickets;; this.wonTickets = fields.wonTickets;; this.ticketPrice = fields.ticketPrice;; this.tokensPerTicket = fields.tokensPerTicket;; this.balance = fields.balance;
    }

    static reified<T extends PhantomReified<PhantomTypeArgument>>(
        T: T
    ): StateReified<ToPhantomTypeArgument<T>> {
        return {
            ...
            new: (
                fields: StateFields<ToPhantomTypeArgument<T>>,
            ) => {
                return new State(
                    [extractType(T)],
                    fields
    ...
    static fromFields<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return State.reified(
            ...
            {id: decodeFromFields(UID.reified(), fields.id), start: decodeFromFields("u64", fields.start), end: decodeFromFields("u64", fields.end), nextTick: decodeFromFields("u64", fields.next_tick), allTickets: decodeFromFields("u64", fields.all_tickets), wonTickets: decodeFromFields("u64", fields.won_tickets), ticketPrice: decodeFromFields("u64", fields.ticket_price), tokensPerTicket: decodeFromFields("u64", fields.tokens_per_ticket), balance: decodeFromFields(Balance.reified(typeArg), fields.balance)}
        )
    }
    ...
    static fromFieldsWithTypes<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return State.reified(
            ...
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), start: decodeFromFieldsWithTypes("u64", item.fields.start), end: decodeFromFieldsWithTypes("u64", item.fields.end), nextTick: decodeFromFieldsWithTypes("u64", item.fields.next_tick), allTickets: decodeFromFieldsWithTypes("u64", item.fields.all_tickets), wonTickets: decodeFromFieldsWithTypes("u64", item.fields.won_tickets), ticketPrice: decodeFromFieldsWithTypes("u64", item.fields.ticket_price), tokensPerTicket: decodeFromFieldsWithTypes("u64", item.fields.tokens_per_ticket), balance: decodeFromFieldsWithTypes(Balance.reified(typeArg), item.fields.balance)}
        )
    }
    ...
    toJSONField() {
        return {
            id: this.id,start: this.start.toString(),end: this.end.toString(),nextTick: this.nextTick.toString(),allTickets: this.allTickets.toString(),wonTickets: this.wonTickets.toString(),ticketPrice: this.ticketPrice.toString(),tokensPerTicket: this.tokensPerTicket.toString(),balance: this.balance.toJSONField(),
    ...
    static fromJSONField<T extends PhantomReified<PhantomTypeArgument>>(
        ...
        return State.reified(
            ...
            {id: decodeFromJSONField(UID.reified(), field.id), start: decodeFromJSONField("u64", field.start), end: decodeFromJSONField("u64", field.end), nextTick: decodeFromJSONField("u64", field.nextTick), allTickets: decodeFromJSONField("u64", field.allTickets), wonTickets: decodeFromJSONField("u64", field.wonTickets), ticketPrice: decodeFromJSONField("u64", field.ticketPrice), tokensPerTicket: decodeFromJSONField("u64", field.tokensPerTicket), balance: decodeFromJSONField(Balance.reified(typeArg), field.balance)}
        )
    }
...
export interface UserStateFields {
    id: ToField<UID>; wonTickets: ToField<"u64">; allTickets: ToField<"u64">
}

export type UserStateReified = Reified<
    UserState,
    UserStateFields
>;
...
export class UserState implements StructClass {
    ...
    private constructor(typeArgs: [], fields: UserStateFields,
        ...
        this.id = fields.id;; this.wonTickets = fields.wonTickets;; this.allTickets = fields.allTickets;
    }
    ...
    static reified(): UserStateReified {
        return {
            ...
            reifiedTypeArgs: [],
            fromFields: (fields: Record<string, any>) =>
                UserState.fromFields(
                    fields,
                ),
            fromFieldsWithTypes: (item: FieldsWithTypes) =>
                UserState.fromFieldsWithTypes(
                    item,
                ),
            fromBcs: (data: Uint8Array) =>
                UserState.fromBcs(
            ...
            fromSuiParsedData: (content: SuiParsedData) =>
                UserState.fromSuiParsedData(
                    content,
                ),
            fetch: async (client: SuiClient, id: string) => UserState.fetch(
                client,
                id,
            ),
            new: (
                fields: UserStateFields,
            ) => {
    ...
    static fromFields(
        ...
        return UserState.reified().new(
            {id: decodeFromFields(UID.reified(), fields.id), wonTickets: decodeFromFields("u64", fields.won_tickets), allTickets: decodeFromFields("u64", fields.all_tickets)}
        )
    }
    ...
    static fromFieldsWithTypes(
        ...
        return UserState.reified().new(
            {id: decodeFromFieldsWithTypes(UID.reified(), item.fields.id), wonTickets: decodeFromFieldsWithTypes("u64", item.fields.won_tickets), allTickets: decodeFromFieldsWithTypes("u64", item.fields.all_tickets)}
        )
    }
    ...
    static fromBcs(
        ...
        return UserState.fromFields(
            UserState.bcs.parse(data)
        )
    }

    toJSONField() {
        return {
            id: this.id,wonTickets: this.wonTickets.toString(),allTickets: this.allTickets.toString(),
    ...
    static fromJSONField(
        ...
        return UserState.reified().new(
            {id: decodeFromJSONField(UID.reified(), field.id), wonTickets: decodeFromJSONField("u64", field.wonTickets), allTickets: decodeFromJSONField("u64", field.allTickets)}
        )
    }
    ...
    static fromJSON(
        ...
        return UserState.fromJSONField(
            json,
        )
    }
    ...
    static fromSuiParsedData(
        ...
        return UserState.fromFieldsWithTypes(
            content
        );
    }
